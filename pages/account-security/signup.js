...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Create an Account - Frevi"/>
                        ...
                        <div className="lg:px-24 md:px-20 sm:px-10 sm:pt-10 pb-10 flex flex-col justify-center md:items-center">
                            ...
                            <div className="mt-7">
                                <p className="text-zinc-800 text-center">
                                    ...
                                    <Link href="/account-security/login" legacyBehavior><a className="font-semibold text-blue-700 hover:underline"> Log In </a></Link>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <form className="mt-5 space-y-5 sm:w-auto md:w-[42rem] w-full" onSubmit={HandleForm}>
                                ...
                                <div className="flex space-x-3 my-4">
                                    ...
                                    <label htmlFor="yes" className="text-zinc-800 cursor-pointer text-sm">
                                        Yes, I understand and agree to the Frevi Terms of Service , including the User Agreement and Privacy Policy
                                    </label>
                                </div>
