...
const Enterprise = () => {
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Frevi Enterprise: Hybrid service solutions"/>
                    ...
                    <div className="container mx-auto mt-5 md:px-4 sm:px-7 px-3">
                        <section className="grid md:grid-cols-2 grid-cols-1 xl:gap-x-20 lg:gap-x-16 md:gap-x-10">
                            <div className="lg:py-36 md:py-24 sm:py-20 py-14">
                                ...
                                >
                                    Goodbye, service gaps. Hello, growth.
                                </motion.h2>
                                ...
                                >
                                    Meet the full-service enterprise solution making service innovation your next big advantage.
                                </motion.p>
            ...
            <main>
                ...
                <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
                    <h2 className="text-zinc-800 xl:text-4xl text-3xl font-semibold">
                        Enterprise Suite is how services get delivered at scale
                    </h2>
                    ...
                    >
                        ...
                        <div className="flex flex-col md:space-y-3">
                            ...
                            <div className="flex flex-col bg-[#115E59] py-5 sm:px-7 px-5 rounded-xl">
                                ...
                                <span className="text-white font-semibold xl:text-2xl text-xl mt-5">
                                    ...
                                    deliver services at a higher caliber.”
                                </span>
                        ...
                        <div className="flex flex-col md:space-y-3">
                            <div className="flex flex-col bg-cyan-700 py-5 sm:px-7 px-5 rounded-xl">
                                ...
                                <span className="text-white font-semibold xl:text-2xl text-xl mt-5">
                                    “Frevi handles blended service delivery in one place, making our operations efficient and streamlined.”
                                </span>
                                <span className="text-gray-300 mt-2">
                                    Hryhorii-Volodymyr Struk, CEO
                                </span>
                                ...
                                <div className="xl:mt-14 mt-7">
                                    ...
                                    <div className="flex flex-col border-t border-white mt-2">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <span className="text-white text-sm">
                                                of successful service deliveries per quarter
                                            </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
                    <h2 className="text-zinc-800 xl:text-4xl text-3xl font-semibold">
                        From small tasks to complex service initiatives, we can help
                    </h2>
                    ...
                    >
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-zinc-800 font-semibold text-xl">
                                    Complete service projects on time
                                </h4>
                                <p className="text-zinc-500 text-[17px] font-semibold">
                                    Deliver tasks and short-term projects with professionals who can meet your business needs.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-zinc-800 font-semibold text-xl">
                                    Adapt and expand your service capacity
                                </h4>
                                <p className="text-zinc-500 text-[17px] font-semibold">
                                    Scale your service delivery with professionals who can meet your growing business demands.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-zinc-800 font-semibold text-xl">
                                    Add more expertise to your services
                                </h4>
                                <p className="text-zinc-500 text-[17px] font-semibold">
                                    Incorporate new skills into your service portfolio to accomplish core company objectives.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-zinc-800 font-semibold text-xl">
                                    Delegate service management to our team
                                </h4>
                                <p className="text-zinc-500 text-[17px] font-semibold">
                                    Explore fully managed solutions to help you deliver complex service projects.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                ...
                <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
                    <h2 className="text-zinc-800 xl:text-4xl text-3xl font-semibold">
                        Enterprise solutions to scale a winning service strategy
                    </h2>
                            ...
                            <div className="flex items-start flex-col space-y-5 bg-gray-700 py-5 sm:px-7 px-5 lg:rounded-xl md:rounded-r-xl md:rounded-bl-none rounded-b-lg">
                                <div className="space-y-2 pb-5 border-b border-white">
                                    ...
                                    <p className="text-white 2xl:text-lg font-semibold">
                                        From service listings to project management to collaboration tools, do it all in one place.
                                    </p>
                                </div>

                                <div className="space-y-2 pb-5 border-b border-white">
                                    <h4 className="text-white font-semibold 2xl:text-3xl text-2xl">
                                        Compliance and service protection
                                    </h4>
                                    <p className="text-white 2xl:text-lg font-semibold">
                                ...
                                <div className="space-y-2 pb-5 border-b border-white">
                                    ...
                                    <p className="text-white 2xl:text-lg font-semibold">
                                        Engage, onboard, and manage your hybrid service team worry-free with our compliant marketplace.
                                    </p>
                                </div>
                        ...
                        >
                            <div className="flex items-start flex-col space-y-5 bg-cyan-700 py-5 sm:px-7 px-5 lg:rounded-xl md:rounded-l-xl md:rounded-br-none rounded-b-lg md:row-start-1 md:row-end-2 row-start-2 row-end-3">
                                ...
                                <div className="space-y-2 pb-5 border-b border-white">
                                    ...
                                    <p className="text-white 2xl:text-lg font-semibold">
                                        Classify and pay your distributed service providers with Frevi Payroll so you can focus on growing your business.
                                    </p>
                                </div>

                                <div className="space-y-2 pb-5 border-b border-white">
                                    <h4 className="text-white font-semibold 2xl:text-3xl text-2xl">
                                        Connect with service providers you trust
                                    </h4>
                                    <p className="text-white 2xl:text-lg font-semibold">
                                        Bring in service providers you already know and manage their experience through one platform.
                                    </p>
                                </div>
                            ...
                            <div className="space-y-4 lg:mt-7 mt-5">
                                ...
                                >
                                    ...
                                    <p className="text-zinc-600 text-[17px] font-semibold">
                                        <span className="font-bold text-zinc-800">Tell us</span> about your needs and the services you're looking for
                                    </p>
                                </motion.div>
                                <motion.div className="flex space-x-2 items-center"
                                            initial={{y:30, opacity:0}}
                                ...
                                >
                                    <IoMdCheckmark className="text-2xl text-green-600"/>
                                    <p className="text-zinc-600 text-[17px] font-semibold">
                                        <span className="font-bold text-zinc-800">Instantly browse</span> qualified service providers with proven expertise
                                    </p>
                                </motion.div>
                                <motion.div className="flex space-x-2 items-center"
                                            initial={{y:30, opacity:0}}
                                ...
                                >
                                    <IoMdCheckmark className="text-2xl text-green-600"/>
                                    <p className="text-zinc-600 text-[17px] font-semibold">
                                        <span className="font-bold text-zinc-800">Implement solutions quickly</span> with our customizable service tools
                                    </p>
                                </motion.div>
                            </div>
                        </div>
                ...
                <section className="w-full bg-gradient-to-tr from-zinc-800 to-gray-800 xl:mt-14 lg:mt-10 md:mt-7 mt-5">
                    ...
                    >
                        ...
                        <p className="text-gray-200 font-semibold mt-4">
                            Enterprise clients benefit from dedicated support with top service providers and a robust platform.
                        </p>
                        ...
                        <div className="grid lg:grid-cols-4 md:grid-cols-2 2xl:gap-x-8 gap-x-7 lg:gap-y-0 gap-y-5 lg:mt-14 mt-10">
                            <div className="px-5 py-5 bg-[#e4ebe4] rounded-xl space-y-2">
                                ...
                                <p className="text-zinc-600 font-semibold text-[17px]">
                                    Maintains your account and works to maximize the return on your service investment.
                                </p>
                            </div>
                            ...
                            <div className="px-5 py-5 bg-[#e4ebe4] rounded-xl space-y-2">
                                ...
                                <p className="text-zinc-600 font-semibold text-[17px]">
                                    Develops custom service solutions tailored to your strategic goals.
                                </p>
                            </div>
                            ...
                            <div className="px-5 py-5 bg-[#e4ebe4] rounded-xl space-y-2">
                                ...
                                <p className="text-zinc-600 font-semibold text-[17px]">
                                    Keeps your team updated on platform best practices and account features.
                                </p>
                            </div>
                            ...
                            <div className="px-5 py-5 bg-[#e4ebe4] rounded-xl space-y-2">
                                ...
                                <h5 className="text-zinc-800 font-semibold text-lg">
                                    Service Implementation Experts
                                </h5>
                                <p className="text-zinc-600 font-semibold text-[17px]">
                                    Supports your team through implementation, from provider selection to project execution.
                                </p>
                            </div>
                        </div>
                ...
                <section className="container mx-auto mt-3 py-3 md:px-5 sm:px-7 px-3 space-y-3">
                    <div className="md:mt-10 mt-5">
                        <h2 className="xl:text-5xl lg:text-4xl text-3xl font-bold text-[#374151] leading-tight">
                            Trusted by leading brands for their service needs
                        </h2>
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-y-0 gap-y-5 xl:gap-x-14 gap-x-7 mt-7">
                            ...
                            >
                                ...
                                <span className="text-white font-semibold xl:text-2xl text-xl mt-5">
                                    "Frevi enables us to deliver services at a higher caliber than our competitors."
                                </span>
                                <span className="text-gray-300 mt-2">
                                    Hryhorii-Volodymyr Struk, CEO
                                </span>
                                ...
                                <div className="xl:mt-14 mt-7">
                                    ...
                                    <div className="flex sm:flex-row flex-col border-t border-white xl:space-x-20 sm:space-x-10 mt-2">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <span className="text-white text-sm">
                                                of successful service deliveries annually
                                            </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
                    <h2 className="text-zinc-800 xl:text-4xl text-3xl font-semibold">
                        Resources to enhance your service capabilities
                    </h2>
                    ...
                    >
                        <div className="flex flex-col justify-between bg-[#dcf5f0] transition hover:bg-[#d3eee8] px-4 py-4 rounded-lg min-h-[8rem] cursor-pointer">
                            <h3 className="text-zinc-800 lg:text-2xl text-xl font-semibold">
                                The Complete Guide to Service Excellence
                            </h3>
                        ...
                        <div className="flex flex-col justify-between bg-[#dcf5f0] transition hover:bg-[#d3eee8] px-4 py-4 rounded-lg min-h-[8rem] cursor-pointer">
                            <h3 className="text-zinc-800 lg:text-2xl text-xl font-semibold">
                                Strategic Guide to Scaling Premium Services
                            </h3>
                        ...
                        <div className="flex flex-col justify-between bg-[#dcf5f0] transition hover:bg-[#d3eee8] px-4 py-4 rounded-lg min-h-[8rem] cursor-pointer">
                            <h3 className="text-zinc-800 lg:text-2xl text-xl font-semibold">
                                Why Trust Is Essential for Service Business Growth
                            </h3>
                        ...
                        <div className="flex flex-col justify-between lg:space-y-10 space-y-5 md:mt-1 mt-2 lg:col-span-2">
                            <div>
                                <h2 className="lg:text-4xl text-2xl text-gray-100 font-semibold">
                                    Discover how Enterprise Suite can transform your service delivery
                                </h2>
                            </div>
                            <div className="lg:flex lg:space-x-7 inline border-t border-gray-100 justify-between py-3 xl:space-y-0 space-y-3">
                                <div>
                                    <h2 className="text-gray-100 font-semibold xl:text-lg">
                                        Join the world's leading service marketplace and deliver excellence, your way.
                                    </h2>
                                </div>

                                <div className="min-w-[25%]">
                                    <button className="border border-gray-100 text-white px-4 lg:py-2 py-1 rounded-full font-semibold transition hover:text-gray-100 hover:border-gray-300">
                                        Talk to an expert
                                    </button>
                                </div>
                            </div>
