    ...
    const GlobalTalent = [
        {
            ...
            text: '"Frevi has taken my business to the next level. Through Frevi, I have engaged with many high quality clients that I would not have been exposed to by my own means." '
        },

        {
            ...
            text: '"I was able to triple my income because of Frevi. I love the chance I have to learn and grow my business through the platform."'
        },

        {
            ...
            text: '"I wake up every day and get to do work I love because of Frevi. Ive worked over 8,000 hours on Frevi and it barely feels like it because I love what I do"'
        },

        {
            ...
            text: '"Frevi has proven to be the best way for me to find high-quality clients and exciting work."'
        },

        {
            ...
            text: '"My goal in 2021 is to reach $1M in earnings on Frevi. That said, I am very grateful for the opportunity that Frevi has created for professionals. '
        },
    ];
                    ...
                    <div className="lg:px-7 sm:px-5 px-0 sm:py-5 py-3">
                        ...
                        <div className="xl:py-7 sm:py-5 py-3 space-y-2">
                            ...
                            <p className={`mt-2 text-zinc-600 xl:text-xl sm:text-lg text-md ${(showQues == true) ? "block" : "hidden"}`}>
                                Our specialized recruiters have experience in the legal industry that enables them to do the heavy lifting on your behalf. In as few as two days, they’ll get back to you with a curated list of pre-vetted remote professionals who tick all the right boxes, selected from the global pool of talent on Frevi.
                            </p>
                            <p className={`mt-2 text-zinc-600 xl:text-xl sm:text-lg text-md ${(showQues == true) ? "block" : "hidden"}`}>
