...
const AdminCustomSupport = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        {/* ============== Head Tag =============== */}
        <HeadTag title="Top Admin & Customer support Talent Experts for Hire in July 2022 | Frevi"/>
        ...
        <main>
           ...
           <TrustedExp
            ...
            <Flexible
                ...
                secondDes="Tophatter, an online auction site for shoppers worldwide, was preparing to expand and needed dozens more multilingual customer support specialists. They struggled finding enough qualified talent and finding talent within budget. By leveraging independent professionals on Frevi, they were able to quickly find the customer support specialists they needed, and within budget.”"
            ...
            <QuestionAsk
                ...
                secondDesText="One of the first steps in hiring any talent is to determine which skills you need for your project. You know you need help with admin and customer support, but what specific things are you trying to do? Frevi matches you with proven remote talent who can help you with all your admin and customer support needs, including"

                thirdHeadText="What are the various ways I can connect with admin and customer support talent through Frevi?"
