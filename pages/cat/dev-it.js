...
const DevIt = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        {/* ============== Head Tag =============== */}
        <HeadTag title="Top Development & IT Experts for Hire in July 2022 | Frevi"/>
        ...
        <main>
           ...
           <TrustedExp
            ...
            <QuestionAsk
                ...
                thirdHeadText="What are the various ways I can connect with development and IT talent through Frevi?"
                thirdDesText="Frevi gives you the flexibility you need to find the right talent for your development and IT projects. Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi labore reiciendis a doloribus! Iusto alias quod itaque officiis, maxime, explicabo inventore voluptas quis odit aut impedit, eius earum eligendi nisi sed sunt aperiam repellat! Unde!"

                fourHeadText="Why should I use Frevi to find talent for development and IT services?"
                fourDesText="Frevi gives you the flexibility you need to find the right talent for your development and IT projects."
