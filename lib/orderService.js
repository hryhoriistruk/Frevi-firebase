...
// Add these functions to orderService.js
export const getOrders = async () => {
    return new Promise((resolve) => {
        const allOrders = mockServices.flatMap(service => service.orders);
        setTimeout(() => resolve({
            data: allOrders,
            success: true,
...
export const deleteOrder = async (serviceName, index) => {
    return deleteOrderFromService(serviceName, index);
};
