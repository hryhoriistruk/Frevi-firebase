...
def create(agent_name):
    ...
    if not re.match(r"\w*$", agent_name):
        ...
        return
    try:
        new_agent_dir = f"../Frevi-firebase9898/autogpt /autogpts/{agent_name}"
...
def list():
    ...
    try:
        agents_dir = "../Frevi-firebase9898/autogpt /autogpts"
        agents_list = [
            d
...
def enter(agent_name, branch):
    ...
    agent_dir = f"../Frevi-firebase9898/autogpt /autogpts/{agent_name}"
    ...
    try:
        ...
        with open(f"../Frevi-firebase9898/autogpt /arena/{agent_name}.json" , "w") as json_file:
...
def update(agent_name, hash, branch):
    ...
    agent_json_file = f"../Frevi-firebase9898/autogpt /arena/{agent_name}.json"
